	  ...
	  <div class="flex-1 p-3 overflow-y-auto">
		<div class="max-w-7xl mx-auto">
		  <div class="mb-6 flex justify-between">
			<h1 class="text-2xl font-bold text-gray-800">Movie</h1>
		  ...
		  >
			...
			<tbody>
			  ...
			  >
				...
				<td class="px-4 py-2 border-b"><NuxtLink :to="`/movies/${movie.ID}`">{{ movie.Title }}</NuxtLink></td>
				...
				<td class="px-4 py-2 border-b">
				  <span
					:class="{
					  'text-green-600 font-semibold': movie.MovieStatus?.Name === 'Now Showing',
					  'text-yellow-700 font-semibold': movie.MovieStatus?.Name === 'Coming Soon',
					  'text-red-700 font-semibold': movie.MovieStatus?.Name === 'Ended'
					}"
				  >
